	 ...
	 <br />
		...
		<tr>
			...
			<? for($i=1; $i<=$nbInd; $i++){
				...
				echo '<td '.FondCase($_GET['ClaInd'.$i],$ligne['Indice'.$i]).'>'.$ligne['Indice'.$i].'</td>';  
		...
		<tr class="Gras">
			...
			<? for($k=1; $k<=$nbInd; $k++){
				...
				echo '<td '.FondCase($_GET['ClaInd'.$k],$tab[$i]['Indice'.$k]).'>'.$tab[$i]['Indice'.$k].'</td>';
		...
		<tr>
			...
			<? for($k=1; $k<=$nbInd; $k++){
				...
				echo '<td '.FondCase($_GET['ClaInd'.$k],$ligne2['Indice'.$k]).'>'.$ligne2['Indice'.$k].'</td>';  
